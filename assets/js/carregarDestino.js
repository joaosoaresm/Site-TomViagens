  ...
  .then(destinos => {
    ...
    document.getElementById("conteudoDestino").innerHTML = `
      <section class="destino-detalhe">
        ...
        <a href="https://wa.me/5512992185458?text=Olá,%20quero%20informações%20sobre%20a%20viagem%20para%20${encodeURIComponent(destino.titulo)}!" target="_blank" class="btn-whatsapp">Reservar pelo WhatsApp</a>
      </section>
    `;
  })
  .catch(err => {
